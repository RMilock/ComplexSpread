...
\begin{frame}{Erdös-Rényi and Fuse models}
	\begin{figure}
		\begin{subfigure}[c]{.48\linewidth}
			\includegraphics[width = \linewidth, trim = {4cm 1cm 2cm 1cm}, clip]{NewPlots/Miscellanea/Erdoes_Renyi_Graph}
...
\begin{frame}{Social Networks \& Results}
	...
	\begin{figure}
		\centering
		\includegraphics[trim = {1cm 1cm 1cm 6cm}, clip, height = \textheight]{NewPlots/CavemanModel/AdjMat/Caveman_Model}
	\end{figure}
\end{frame}
...
\begin{frame}{\textit{Pruning} Watts-Strogatz SW Network (p = 0.0)}
	...
	\begin{figure}[h]
		\centering
		\animategraphics[label = taylor, width=\linewidth,loop,controls]{1}{NewPlots/WS_Pruned/Gifs/WS_Pruned/WS_Pruned_p0_}{1}{3}
	\end{figure}
\end{frame}
