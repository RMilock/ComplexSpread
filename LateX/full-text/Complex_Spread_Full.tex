...
\begin{figure}[p]
	...
	\begin{subfigure}{\linewidth}
		...
		\caption{A pathogen with faster human-recovery but more infectivity than the COVID-19 one. 
		\newline $\Delta R_{0}|_{present} > \Delta R_{0-COVID-19}$, rather, $\Delta R_0 (\delta)|_{present} \lesssim \Delta R_0 (\delta)|_{COVID-19}$ could be considered a more concrete mark of the epidemic bourden.}
	...
	\begin{subfigure}{\linewidth}
		...
		\caption{The sub-exponential growth for a $D$ slightly above $D_c$ of \autoref{fig:Ordp_OPSW_highmu_COVID19}}
...
\begin{figure}[ht]
	\includegraphics[width = \linewidth]{Results/PSW/SPSW/p0.0/NN_Conf_Model_SIR_R0_1_N1000_D23.0_p0.0_beta0.015_d4.0.png}
...
\begin{figure}[p]
	...
	\begin{subfigure}{\linewidth}
		...
		\caption{The evolution for a larger number of contact $D = 10$. This is slightly above the threshold, implying the exponential outbreak at early times.}
...
\caption{(Quasi-)Linearity for the last of simulated epidemics. An evolution for $D > D_c \sim 24$ would exhibit a exponential growth of the number of total cases.}
...
\begin{figure}[t]
	...
	\begin{subfigure}{0.48\linewidth}
		\centering
		\includegraphics[width=\linewidth, keepaspectratio]{Results/PSW/SPSW/OrdParam/p0.0/NN_Conf_Model_ordp_p0.0_beta0.015_d4.0.png}
...
\end{equation} 
where $N_{cl}, L_{nx}$ are, respectively, the number of nodes composing a community and the number of links, which the next community is reached with. $L_{ilr}$ is so defined for an algorithmic simplicity to state only half of the links to be used to link to a forward clique.
...
\begin{figure}[H]
	\centering
	\includegraphics[scale = 0.15]{Results/BA_Model/p0.0/BA_Model_SIR_R0_1_N1000_D47.0_p0.0_beta0.015_d1.0.png}
...
\begin{figure}[t]
	...
	\begin{subfigure}[t]{0.48\linewidth}
		\centering
		\includegraphics[width = \linewidth, height = 5cm]{Results/BA_Model/OrdParam/BA_Model_ordp_p0.0_beta0.015_d1.0.png}
