...
\begin{figure}[h]
	\centering
	\includegraphics[width = .7\linewidth]{Results/WS_Pruned/Network/WS_Pruned_AdjMat_1000_500.0_0.0.png}
...
\begin{figure}[t]
	\centering
	\includegraphics[width = .7\linewidth]{Results/WS_Pruned/Network/WS_Pruned_AdjMat_1000_500.0_0.1.png}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Watts-Strogatz model spreading curves for $D = 6$ and $D = 14$.}
\end{figure}
