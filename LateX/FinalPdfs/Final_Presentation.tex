...
\begin{frame}{Motivations from COVID-19 Data}
	\begin{figure}[h]
		\centering
		\includegraphics[width = \linewidth]{Motivations/COVID-RealStates_2020-02-25.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	\frametitle{Example}
	\includegraphics[width=\linewidth]{WS_Pruned_SIR_R0_3_N1000_D30.0_p0.0_beta0.007_d14.0}
\end{frame}

\logo{}
\begin{frame}{First Order Phase Transition-like}
	\vspace*{-2mm}
	...
	\begin{block}{Critical average degree $D_c$ for different topologies}
		\begin{itemize}
			\item \textit{Homogeneous MF}: $\frac{\beta D_c}{\mu} \stackrel{!}{=} 1 \Leftrightarrow 
			\textcolor{darkgreen}{D_{c-homog} = \frac{\mu}{\beta}}$
	...
	\begin{tikzpicture}[overlay, remember picture]
		\node[left = 1cm] at (current page.05){
			\includegraphics[width=2cm, trim = {5cm 7cm 4cm 7cm}, clip]{Miscellanea/Erdoes_Renyi_Graph}
		};
	\end{tikzpicture}
	\begin{tikzpicture}[overlay, remember picture]
		\node[left = 2.5cm] at (current page.343){
			\includegraphics[width=2.5cm]{Miscellanea/Fuse_Model1}
		};
	\end{tikzpicture}
\end{frame}

\begin{frame}
	\frametitle{Example of Order Parameter with Long-Range interactions}
	\begin{figure}[t]
		\vspace{-0.5cm}
		\centering
		\includegraphics[width=\linewidth, keepaspectratio]{PoissSW/OrdP/NNO_Conf_Model_ordp_p0.3_beta0.015_d14.0.png}
	\end{figure}
	\begin{tikzpicture}[overlay, remember picture]
		\node[inner sep=0pt] (subexpo) at (3.6,6.4){
			\includegraphics[width=5cm, height = 1.56cm, frame = 0.007pt]{PoissSW/OrdP/ExampleSIR/NNO_Conf_Model_SIR_R0_0_N1000_D2.0_p0.3_beta0.015_d14.0}
		};
		\draw[line width = 0.02mm] (subexpo.south east) -- (1.68,2);
		\draw[line width = 0.02mm] (subexpo.south west) -- (1.68,2);
	\end{tikzpicture}
	\begin{tikzpicture}[overlay, remember picture]
		\node[left = 0.2cm,inner sep=0pt] (expo) at (current page.007){
			\includegraphics[width=2.3cm, height = 2.7cm, frame = 0.007pt]{PoissSW/OrdP/ExampleSIR/NNO_Conf_Model_SIR_R0_11_N1000_D54.0_p0.3_beta0.015_d14.0.png}
		};
		\draw[line width = 0.01mm] (expo.north east) -- (10.4,6.7);
		\draw[line width = 0.01mm] (expo.north west) -- (10.3,6.7);
	\end{tikzpicture}
\end{frame}
...
\begin{frame}{Social Networks \& Results}
	...
	\begin{figure}[t]
		\begin{subfigure}[t]{0.48\linewidth}
			\centering
			\includegraphics[height = .48\textheight, trim = {0 0 2cm 0}, clip,]{NetworksExhibition/Barabasi_Albert_Model_new.png}
		\end{subfigure}
		\hfill
		\centering
		\begin{subfigure}[t]{0.48\linewidth}
			\centering
			\includegraphics[height = .48\textheight]{NetworksExhibition/Overlapping_PSW_new.png}
	...
	\begin{figure}[b]
		\begin{subfigure}[b]{0.48\linewidth}
			\centering
			\includegraphics[trim = {3cm, 1cm, 3cm, 3cm}, clip, height = .7\textwidth]{NetworksExhibition/Regular Lattice}
		...
		\begin{subfigure}[b]{0.48\linewidth}
			\centering
			\includegraphics[trim = {1cm 1cm 1cm 3cm}, clip, height = .48\textheight]{NetworksExhibition/Caveman_Model}
		\end{subfigure}
	\end{figure}
	\vspace{-1cm}
	}
...
\begin{frame}{Decreasing Heterogeneity}
	\begin{figure}
		\centering
		\animategraphics[trim = {0cm 5.5cm 1cm 4cm}, height = .78\textheight, controls]{1}{HL_Heterog/AdjMat/AdjMat_title_}{1}{4}
	\end{figure}
\end{frame}

\begin{frame}{Decreasing COVID-19 Outbreaks \cite{Thurner::NetBasedExpl}}
	\vspace{-2mm}
	\Wider[2em]{
	\begin{figure}
		\centering
		\animategraphics[trim = {1cm 0cm 1cm 5cm}, width=\linewidth, loop, height = .8\textheight, controls]{1}{HL_Heterog/SIR/SIR_pdf_}{1}{4}
	\end{figure}
	}
\end{frame}
	...
	\begin{center}
		\begin{tabular}{||c|c|c|c||}
			...
			\begin{minipage}[c][.22\textheight]{.21\textwidth}
				\centering
				\includegraphics[trim = {1cm 7cm 1cm 4cm}, clip, height = .21\textheight]{NetworksExhibition/Caveman_Model}
			\end{minipage}
			...
			\begin{minipage}[c][.22\textheight]{.21\textwidth}
				\centering
				\includegraphics[trim = {3cm, 7cm, 3cm, 3.1cm}, clip, height = .21\textheight]{NetworksExhibition/Regular Lattice} 
			\end{minipage}
			& -- & $(6 \pm 2.3 )\%$ & Peaked \\
			\hline
			\begin{minipage}[c][.22\textheight]{.21\textwidth}
				\centering
				\includegraphics[trim = {3cm, 7cm, 3cm, 3.1cm}, clip, height = .21\textheight]{NetworksExhibition/Overlapping_PSW_new.png} 
			\end{minipage}
			& -- & $(7.4 \pm 2.5 )\%$ & \begin{tabular}{@{}c@{}}Mid Heterogeneity \\ (No Hubs)\end{tabular} \\
			\hline
			\begin{minipage}[c][.22\textheight]{.21\textwidth}
				\centering
				\includegraphics[trim = {3cm, 7cm, 3cm, 3.4cm}, clip, height = .21\textheight]{NetworksExhibition/Barabasi_Albert_Model_new.png} 
			\end{minipage}
...
\begin{frame}{\textit{Fixed $R_0$} SIR + Regular Lattice}
	...
	\begin{figure}[h]
		\centering
		\animategraphics[width=.92\linewidth, loop, height = 0.7\textheight, controls]{1}{WS_Pruned/Gifs/WS_Pruned/WS_Pruned_p0_}{1}{3}
	\end{figure}
	}
\end{frame}
...
\begin{frame}{Order Parameter ($SD(C)$) of an Overlapping PSW}
	...
	\begin{figure}[t]
		\begin{subfigure}[t]{0.49\linewidth}
			\centering
			\includegraphics[width=\linewidth, keepaspectratio]{PoissSW/OrdP/NNO_Conf_Model_ordp_p0.0_beta0.015_d14.0.png}
			\caption{Short-Range Interactions}
		\end{subfigure}
		\hfill
		\begin{subfigure}[t]{0.49\linewidth}
			\centering
			\includegraphics[width=\linewidth, keepaspectratio]{PoissSW/OrdP/NNO_Conf_Model_ordp_p0.3_beta0.015_d14.0.png}
			\caption{Long-Range Interactions}
		\end{subfigure}
...
\begin{frame}{Order Parameter ($SD(C)$) of a Barabási-Albert Model}
	...
	\begin{figure}
		\begin{subfigure}[t]{.49\linewidth}
			\includegraphics[width = \linewidth]{BA_Model/Ordp/BA_Ordp_1}
			\caption{Preferential Attachment + d = 14}
		\end{subfigure}
		\hfill
		\begin{subfigure}[t]{.49\linewidth}
			\includegraphics[width = \linewidth]{BA_Model/Ordp/BA_Ordp_2.png} %trim = {0 24.9cm 0 6cm}
			\caption{Preferential Attachment + d = 4}
...
\begin{enumerate}
	...
	\item For Overlapping PSW, $ D_c$ is well estimated by the \textit{Fuse model} \underline{only} for long-range COVID-19 parameters;
...
\begin{frame}
	...
	\bibliography{Plots/my_bibliography.bib}
\end{frame}
...
\begin{frame}{Order Parameter: Erdös-Rényi and Fuse models}
	\begin{figure}
		\begin{subfigure}[c]{.48\linewidth}
			\includegraphics[width = \linewidth, trim = {4cm 1cm 2cm 7.5cm}, clip]{Miscellanea/Erdoes_Renyi_Graph}
			\caption{Erdös-Rényi model ($N = 8, p = 0.4$)}
		\end{subfigure}
		\hspace{0.3mm}
		\begin{subfigure}[c]{.48\linewidth}
			\includegraphics[width = \linewidth, trim = {2cm 2.3cm 1.3cm 0cm}, clip]{Miscellanea/fuse_model} %trim = {0 24.9cm 0 6cm}
...
\begin{frame}{Regular Lattice model}
	\begin{figure}
		\begin{subfigure}{.48\linewidth}
			\includegraphics[width = \linewidth, trim = {3cm 1cm 2cm 1cm}, clip]{WS_Pruned/AdjMat/WS_Pruned_AdjMat_1000_500.0_0.0.png}
		\end{subfigure}
		\hspace{1mm}
		\begin{subfigure}{.48\linewidth}
			\includegraphics[width = \linewidth, trim = {3cm 1cm 2cm 1cm}, clip]{WS_Pruned/AdjMat/WS_Pruned_AdjMat_1000_500.0_0.3.png} %trim = {0 24.9cm 0 6cm}
		\end{subfigure}%New_Plots/WS_Pruned/AdjMat/WS_Pruned_AdjMat_1000_30.0_0.1.png}}
	%\caption{Title for both}
...
\begin{frame}{COVID-19 SIR + Regular Lattice}
	...
	\begin{figure}[h]
		\centering
		\animategraphics[width=\linewidth, loop, height = 0.7\textheight, controls]{1}{WS_Epids/WS_Epids_}{1}{5}
	\end{figure}
	}
\end{frame}
...
\begin{frame}{Poissonian Small-World Networks}
	\begin{figure}
		\begin{subfigure}{.48\linewidth}
			\includegraphics[width = \linewidth, trim = {3cm 1cm 2cm 1cm}, clip]{PoissSW/OPSW/NNO_Conf_Model_AdjMat_1000_25.0_0.0.png}
		\end{subfigure}
		\hspace{1mm}
		\begin{subfigure}{.45\linewidth}
			\includegraphics[width = \linewidth, trim = {3cm 1cm 2cm 1cm}, clip]{PoissSW/OPSW/NN_Conf_Model_AdjMat_1000_21.0_0.0.png} %trim = {0 24.9cm 0 6cm}
		\end{subfigure}%New_Plots/WS_Pruned/AdjMat/WS_Pruned_AdjMat_1000_30.0_0.1.png}}
...
\begin{frame}{COVID-19 SIR + Overlapping PSW}
	...
	\begin{figure}[h]
		\centering
		\animategraphics[width=\linewidth, loop, height = 0.7\textheight, controls]{1}{PoissSW/OPSW/Gifs/OPSW_}{1}{6}
	\end{figure}
	}
\end{frame}
...
\begin{frame}{Caveman Model}
	...
	\begin{figure}
		\centering
		\animategraphics[trim = {1cm 1cm 1cm 1cm}, height = .8\textheight, controls]{1}{CavemanModel/AdjMat/CM_AdjMat_}{1}{2}
	\end{figure}
\end{frame}
...
\begin{frame}{COVID-19 SIR + Caveman Model}
	...
	\begin{figure}[h]
		\centering
		\animategraphics[width=\linewidth, loop, height = 0.7\textheight, controls]{1}{CavemanModel/Gifs/CM_}{1}{4}
	\end{figure}
\end{frame}
...
\begin{frame}{(Regular) Barabási-Albert Model}
	...
	\begin{figure}
		\centering
		\includegraphics[trim = {1cm 1cm 1cm 0cm}, clip, height = .9\textheight]{BA_Model/AdjMat/BA_Model_AdjMat_1000_28.0_0.0_14_14.png}
	\end{figure}
\end{frame}
...
\begin{frame}{COVID-19 SIR + Barabási-Albert Model}
	...
	\begin{figure}[h]
		\centering
		\animategraphics[width=\linewidth, loop, height = 0.7\textheight, controls]{1}{BA_Model/Gifs/BA_}{1}{3}
	\end{figure}
	}
\end{frame}

\begin{frame}{Order Parameter $(SD(C))$ - Overl PSW - d = 4}
	\vspace{-2mm}
	\Wider[2em]
	{
	\begin{figure}[t]
		\begin{subfigure}[t]{0.49\linewidth}
			\centering
			\includegraphics[width=\linewidth, keepaspectratio]{PoissSW/OrdP/NNO_Conf_Model_ordp_p0.0_beta0.015_d4.0.png}
			\caption{Short-Range Interactions}
		\end{subfigure}
		\hfill
		\begin{subfigure}[t]{0.49\linewidth}
			\centering
			\includegraphics[width=\linewidth, keepaspectratio]{PoissSW/OrdP/NNO_Conf_Model_ordp_p0.3_beta0.015_d4.0.png}
			\caption{Long-Range Interactions}
		\end{subfigure}
		%\caption{Order Parameter for Regular OPSW with different recovery rates at $p = 0$. }
	\end{figure}
...
\begin{figure}
	...
	\begin{subfigure}{.6\linewidth}
		\includegraphics[width = \linewidth, trim = {0 0 0 5cm}, height = 6.5cm, clip]{WS_Pruned/AdjMat/WS_Pruned_AdjMat_1000_30.0_0.1.png} %trim = {0 24.9cm 0 6cm}
	\end{subfigure}%New_Plots/WS_Pruned/AdjMat/WS_Pruned_AdjMat_1000_30.0_0.1.png}}
%\caption{Title for both}
\end{figure}
\end{frame}
...
\begin{frame}{\textit{Pruning} Watts-Strogatz SW Network (p = 0.0)}
	...
	\begin{figure}[h]
		\centering
		\animategraphics[label = taylor, width=\linewidth,loop,controls]{1}{WS_Pruned/Gifs/WS_Pruned/WS_Pruned_}{1}{3}
	\end{figure}
\end{frame}

\begin{frame}{Adjacency Matrix WS(p = 0.3)}
	\centering
	\includegraphics[width = .8\linewidth, height = \textheight]{WS_Pruned/AdjMat/WS_Pruned_AdjMat_1000_500.0_0.3.png}
\end{frame}

\begin{frame}{WS-SIR Model (p = 0.3)}
	\begin{figure}[h]
		\centering
		\animategraphics[width=\linewidth,loop,controls]{1}{WS_Pruned/Gifs/WS_Pruned_p0.3/WS_Pruned_p0.3_}{1}{3}
	\end{figure}
\end{frame}
...
\begin{frame}{Network Model Overview}
	\begin{figure}[t]
		...
		\subfloat["Sparse PSW"]{\includegraphics[width=0.5\linewidth, height = 0.8 \textheight]{PoissSW/SPSW/NN_Conf_Model_AdjMat_1000_49.0_0.0.png}}
		\hfill
		\subfloat["Overlapping PSW"]{\includegraphics[width=0.5\linewidth, height = 0.8 \textheight]{PoissSW/OPSW/NNO_Conf_Model_addE_True_AdjMat_1000_50.0_0.0.png}}
	\end{figure}
\end{frame}
...
\begin{frame}{SPSW-SIR model (p = 0.0, 0.3)}
	\begin{figure}[h]
		\centering
		\animategraphics[width=\linewidth,height = .75 \textheight, loop,controls]{1}{PoissSW/SPSW/Gifs/SPSW-}{1}{6}
	\end{figure}
\end{frame}
...
\begin{frame}{OPSW-SIR model (p = 0.0, 0.3)}
	\begin{figure}[h]
		\centering
		\animategraphics[width=\linewidth,height = .75 \textheight, loop,controls]{1}{PoissSW/OPSW/Gifs/OPSW-}{1}{4}
	\end{figure}
\end{frame}
...
\begin{frame}{Order Parameters - Sparse-Overlapped (p = 0.0, 0.3)}
	\begin{figure}[h]
		\centering
		\animategraphics[width=\linewidth,height = .75 \textheight, loop,controls]{1}{PoissSW/OrdP/OParameter-}{1}{4}
	\end{figure}
\end{frame}
...
\begin{frame}{Adjacency Matrix Caveman Model (p = 0.0, 0.3)}
	\begin{figure}[h]
		\centering
		\animategraphics[width = .8 \linewidth, height = .8\textheight, loop, controls]{1}{CavemanModel/AdjMat/CMMod_AdjMat-}{1}{2}
	\end{figure}
\end{frame}
...
\begin{frame}{SIR Caveman Model (p = 0.0, 0.3)}
	\begin{figure}[h]
		\centering
		\animategraphics[width = \linewidth, height = .8\textheight, loop, controls]{1}{CavemanModel/Gifs/CMod_SIR-}{1}{6}
	\end{figure}
\end{frame}
...
\begin{frame}{Adjacency Matrix Barabási-Albert Model (p = 0.0)}
	\begin{figure}[h]
		\centering
		\animategraphics[width = .8 \linewidth, height = .8\textheight, loop, controls]{1}{BA_Model/AdjMat/BA_AdjMat-}{1}{2}
	\end{figure}
\end{frame}
...
\begin{frame}{SIR Barabási-Albert Model (p = 0.0)}
	\begin{figure}[h]
		\centering
		\animategraphics[width = \linewidth, height = .8\textheight, loop, controls]{1}{BA_Model/Gifs/BA_SIR-}{1}{3}
	\end{figure}
\end{frame}
...
\begin{frame}{Order Parameter Barabási-Albert Model (p = 0.0)}
	\begin{figure}[h]
		\centering
		\animategraphics[width = \linewidth, height = .8\textheight, loop, controls]{1}{BA_Model/Ordp/BA_Ordp-}{1}{2}
	\end{figure}
\end{frame}
